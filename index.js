import{a as y,S as h,i as g}from"./assets/vendor-BNibzuFn.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function i(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(e){if(e.ep)return;e.ep=!0;const r=i(e);fetch(e.href,r)}})();const p="52797482-aafa905b189c4ff0c9ee358ec";function m(s){return y("https://pixabay.com/api/",{params:{key:p,q:s,image_type:"photo",orientation:"horizontal",safesearch:!0}}).then(({data:t})=>{if(t.hits.length>0)return t}).catch(t=>{})}const c=document.querySelector(".gallery"),u=document.querySelector("span"),b=new h(".gallery-link",{captionsData:"alt",captionDelay:250});function v(s){c.insertAdjacentHTML("beforeEnd",s.map(({webformatURL:t,largeImageURL:i,tags:a,likes:e,views:r,comments:l,downloads:f})=>`<li class="galerry-list">
    ...
    </li>`).join("")),b.refresh()}function x(){c.textContent=""}function L(){u.classList.remove("hidden")}function n(){u.classList.add("hidden")}const d=document.querySelector(".form"),o=d.elements["search-text"];d.addEventListener("submit",w);function w(s){if(s.preventDefault(),x(),L(),!o.value.trim())return n(),o.value="";m(o.value).then(t=>{throw t&&t.hits&&v(t.hits),new Error(response.status)}).catch(t=>g.error({message:"Sorry, there are no images matching your search query. Please try again!",position:"topRight",color:"red"})).finally(()=>n()),s.target.reset()}
